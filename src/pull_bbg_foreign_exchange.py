...
def pull_fx_data(start_date="1950-01-01", end_date=END_DATE):
    ...
    print(">> Pulling FX data from Bloomberg...")

    # Pull each set of tickers
    print("   Pulling interest rates...")
